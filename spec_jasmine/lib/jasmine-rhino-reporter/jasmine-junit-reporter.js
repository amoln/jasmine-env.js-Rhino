(function() {
    ...
    JUnitXmlReporter.prototype = {
        ...
        reportRunnerResults: function(runner) {
            ...
            if (failedCount > 0) {
              console.log("*** "+failedCount+" specs failed, creating hudson report and exiting with code 1 ***")
              java.lang.System.exit(1);
            } else if(failedCount == 0) {
              console.log("*** All specs passed, exiting with code 0 ***")
        ...
        writeFile: function(filename, text) {
            ...
            try {
                ...
                out.write(text);
                out.close();
            } catch (e) { this.log("*** Rhino could not write out the hudson report, Reason - "+e.message+" ***"); }
